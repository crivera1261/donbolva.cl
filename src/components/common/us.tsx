export const Us = () : any => {
   return( <section id="nosotros" className="mb-15  border-earth/10">
          ...
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <h3 className="mt-3 font-serif text-2xl">Nos adaptamos a su tiempo</h3>
              <p className="mt-2 text-sm leading-relaxed text-earth/60">
                Usted decide cuándo recibir: mañana o tarde, el día que mejor le acomode.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-earth/60">
                Entrega en su puerta. Pague en efectivo o por transferencia cuando reciba la canasta.
              </p>
            </div>
          </div>
        </section>
